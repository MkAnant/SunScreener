...
const Skin = () => {
  ...
  const goToVitamin = (e) => {
    ...
    const { skinInput } = Object.fromEntries(formData.entries());
    navigate("/vitamin", { state: { skinInput } });
  };
  ...
  const skinType = [
    ...
    },
    {
      ...
      color: "IV",
      features:
        "Olive skin, Mediterranean Caucasian skin; dark brown hair; medium to heavy pigmentation",
  ...
  return (
    <main className="skin">
      <Header
        title={"Skin Type"}
        subtitle={"SELECT THE TYPE THAT BEST MATCHES YOUR SKIN"}
      />
        ...
        <table border={0.5}>
          <thead>
            <tr className="primary-font primary-color">
              <th>
                <h3 className="primary-font primary-color">Type</h3>
              </th>
              <th>
                <h3 className="primary-font primary-color">Color</h3>
              </th>
              <th>
                <h3 className="primary-font primary-color">Typical Features</h3>
              </th>
              <th>
                <h3 className="primary-font primary-color">Ethnicity</h3>
              </th>
            </tr>
          </thead>
          <tbody>
